...
import moment from 'C:/Users/Lenovo/Desktop/DoNotTouch/БД/4/CRM-repo/crm/clientUmi1/crmCLient/node_modules/moment';
import 'C:/Users/Lenovo/Desktop/DoNotTouch/БД/4/CRM-repo/crm/clientUmi1/crmCLient/node_modules/moment/locale/ru';
import { RawIntlProvider, getLocale, getDirection , setIntl, getIntl, localeInfo, event, LANG_CHANGE_EVENT } from './localeExports';

import antd_es_locale_ru_RU from 'antd/es/locale/ru_RU';
...
export function _onCreate() {
  ...
  if (moment?.locale) {
    moment.locale(localeInfo[locale]?.momentLocale || 'ru');
  }
  setIntl(locale);
}
